...
public class TestGenetics
{
	...
	// next population bestaat uit geselecteerde ouders (select Parents) en aangevuld met kinderen (new Children)
	{
		...
		TestIndividual[] children = crossoverChildren( numChildren, parents );
	...
	{	// select parents with fitness larger than average fitness
		...
		TestIndividual[] parents = new TestIndividual[aantalOuders];
	...
	public static TestIndividual[] crossoverChildren( int numChildren, TestIndividual[] parents )
	...
	public static TestIndividual createChild(TestIndividual parent1, TestIndividual parent2)
	{
